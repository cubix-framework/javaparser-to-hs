 ...
 * @version $Id: TokenMarker.java 1314 2006-04-19 15:40:22Z daleanson $
 *
...
//	public static final int ACTION_HINT_15 = 1 << 15;
	...
	public LineContext markTokens(LineContext prevContext,
		TokenList tokenList, Segment line)
	{
	 ...
	 */
	private boolean handleRule(TokenList tokenList, Segment line,
	...
	//{{{ markKeyword() method
	private void markKeyword(TokenList tokenList, Segment line,
		int start, int end)
	{
