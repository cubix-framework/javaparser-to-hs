 ...
 *@created    26 May 2002
 */
public class SplitCompoundView
     ...
     */
    public SplitCompoundView(String name, String toolTipText,
                             String dividerPropertyName, AbstractCVSView view1,
                             AbstractCVSView view2,
                             AbstractCVSView viewToGetCWDFrom, Icon icon,
    ...
    public void start(ViewManager manager) {
        ...
        split = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, true,
                               view1.getViewComponent(), m);
        split.setOneTouchExpandable(true);
        split.setDividerSize(9);

        int i = getManager().getContext().getHost().getIntegerProperty(
            dividerPropertyName,
            -1);
    ...
    public void stop() {
        view1.stop();
        view2.stop();
        getManager().getContext().getHost().setIntegerProperty(
            dividerPropertyName,
    ...
    public void viewEvent(ViewEvent evt) {
        ...
        if (view instanceof AbstractCVSView &&
            (evt.getType() == ViewEvent.SELECTION_CHANGED) &&
            !evt.isAdjusting()) {
        ...
        else if (view instanceof AbstractCVSView &&
                 (evt.getType() == ViewEvent.CWD_CHANGED) && !evt.isAdjusting()) {
            ...
            setFolderBar(sel);
                 ...
                 (evt.getType() == ViewEvent.VIEW_CHANGED)) {
            ...
            if (view == view1) {
                split.setLeftComponent(view.getViewComponent());
                     ...
                     (mainRightPanel.getComponent(0) != view.getViewComponent())) {
