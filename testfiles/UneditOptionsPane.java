 ...
 *@created    26 May 2002
 */
public class UneditOptionsPane
    extends Tabber {
    ...
    class UneditGeneralTab
        ...
        UneditGeneralTab() {
            ...
            setTabLargeIcon(UIUtil.getCachedIcon(
                Constants.ICON_TOOL_LARGE_UNEDIT));
            ...
            doNotRecurse.setSelected(context.getHost().getBooleanProperty(
                Constants.UNEDIT_GENERAL_DO_NOT_RECURSE,
                false));
        ...
        public void applyTab() {
            context.getHost().setBooleanProperty(Constants.
                                                 UNEDIT_GENERAL_DO_NOT_RECURSE,
                                                 doNotRecurse.isSelected());

            String n = watch.getSelectedWatchName();
            context.getHost().setProperty(Constants.UNEDIT_GENERAL_TEMP_WATCH,
                                          (n == null) ? "" : n);
        }
